 ...
 */
class User extends \OAuth2\ServerBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\User' . "\0" . 'scopes');
        }
