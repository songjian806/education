 ...
 */
class AuthorizationCode extends \OAuth2\ServerBundle\Entity\AuthorizationCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\AuthorizationCode' . "\0" . 'code', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\AuthorizationCode' . "\0" . 'expires', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\AuthorizationCode' . "\0" . 'user_id', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\AuthorizationCode' . "\0" . 'redirect_uri', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\AuthorizationCode' . "\0" . 'scope', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\AuthorizationCode' . "\0" . 'client');
        }
