 ...
 */
class AccessToken extends \OAuth2\ServerBundle\Entity\AccessToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\AccessToken' . "\0" . 'token', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\AccessToken' . "\0" . 'user_id', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\AccessToken' . "\0" . 'expires', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\AccessToken' . "\0" . 'scope', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\AccessToken' . "\0" . 'client');
        }
