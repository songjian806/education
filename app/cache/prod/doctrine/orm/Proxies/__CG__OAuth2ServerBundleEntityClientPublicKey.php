 ...
 */
class ClientPublicKey extends \OAuth2\ServerBundle\Entity\ClientPublicKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\ClientPublicKey' . "\0" . 'client', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\ClientPublicKey' . "\0" . 'client_id', '' . "\0" . 'OAuth2\\ServerBundle\\Entity\\ClientPublicKey' . "\0" . 'public_key');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClientPublicKey $proxy) {
