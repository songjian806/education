...
class __TwigTemplate_5d719ff6350f049d4ebf5976b16d5e27060e151f3aca36bd8d2a508999c3506f extends Twig_Template
{
  ...
  <div class=\"metas\">";
        // line 17
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("共有%courseNum%门课程", array("%courseNum%" => (("<span>" + $this->getAttribute((isset($context["classroom"]) ? $context["classroom"] : null), "courseNum", array())) + "</span>"))), "html", null, true);
        echo "</div>
</div>";
    }
