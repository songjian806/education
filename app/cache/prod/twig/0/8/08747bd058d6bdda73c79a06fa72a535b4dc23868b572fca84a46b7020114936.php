...
class __TwigTemplate_08747bd058d6bdda73c79a06fa72a535b4dc23868b572fca84a46b7020114936 extends Twig_Template
{
  ...
  ";
    ...
    ";
      ...
      ";
                    ...
                    // line 20
                    echo "        <span class=\"price\">";
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("%price%元", array("%price%" => $this->getAttribute((isset($context["course"]) ? $context["course"] : null), "price", array()))), "html", null, true);
                    echo "</span>
      ";
                }
                // line 22
    ...
    ";
      ...
      ";
                    ...
                    // line 28
                    echo "        <span class=\"origin-price\"><del>";
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("%originPrice%元", array("%originPrice%" => $this->getAttribute((isset($context["course"]) ? $context["course"] : null), "originPrice", array()))), "html", null, true);
                    echo "</del></span>
      ";
                }
                // line 30
    ...
    ";
      ...
      <span class=\"discount\">
        ...
        ";
                    ...
                    // line 38
                    echo "          ";
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("%discount%折", array("%discount%" => twig_round($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "discount", array()), 2, "common"))), "html", null, true);
                    echo "
        ";
                }
                // line 40
