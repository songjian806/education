...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getBazinga_Jstranslation_ControllerService()
    {
        ...
        $this->services['bazinga.jstranslation.controller'] = $instance = new \Bazinga\Bundle\JsTranslationBundle\Controller\Controller($this->get('translator.default'), $this->get('templating'), $this->get('bazinga.jstranslation.translation_finder'), (__DIR__.'/bazinga-js-translation'), true, 'en', 'messages', '86400');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'edusoho', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(), 'wrapperClass' => 'Topxia\\Service\\Common\\Connection'), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_244561738a0f189bb6c0da40614e07b57d5a21721723b6cfacffd21d7c6579c5');
    ...
    {
        return $this->services['templating'] = new \Symfony\Bundle\TwigBundle\Debug\TimedTwigEngine($this->get('twig'), $this->get('templating.name_parser'), $this->get('topxia.templating.locator'), $this->get('debug.stopwatch'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor2\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views'), 'WebProfiler');
        $instance->addPath(($this->targetDirs[3].'\\vendor2\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views'), 'SensioDistribution');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'twig.options' => array(
                ...
                'paths' => array(
                    'C:\\wamp\\www\\htdocs\\app/../web/customize' => 'customize',
                    'C:\\wamp\\www\\htdocs\\app/../src/Topxia/WebBundle/Resources/views' => 'topxiaweb',
                    'C:\\wamp\\www\\htdocs\\app/../web/themes' => 'theme',
                    'C:\\wamp\\www\\htdocs\\app/../' => 'root',
                ),
