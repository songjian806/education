...
class __TwigTemplate_065fc2af7cdfa4e6edc6acbc1693fcb1f731b90f159e4c37c5fa935f43249553 extends Twig_Template
{
    ...
    <div id=\"bar-phone-content\">
      ";
            ...
            if ( !twig_test_empty($this->getAttribute((isset($context["consult"]) ? $context["consult"] : $this->getContext($context, "consult")), "worktime", array()))) {
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("工作时间：%worktime%", array("%worktime%" => $this->getAttribute((isset($context["consult"]) ? $context["consult"] : $this->getContext($context, "consult")), "worktime", array()))), "html", null, true);
                echo "</p>
      ";
            }
            // line 60
